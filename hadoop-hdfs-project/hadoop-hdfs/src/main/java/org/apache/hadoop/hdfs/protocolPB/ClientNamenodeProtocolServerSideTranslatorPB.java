...
public class ClientNamenodeProtocolServerSideTranslatorPB implements
  ...
  @Override
  public ClientNamenodeProtocolProtos.CheckPermissionResponseProto checkPermission(RpcController controller,
                                                                                   ClientNamenodeProtocolProtos.CheckPermissionRequestProto req)
          throws ServiceException {
    try {
      boolean result = server.checkPermission(req.getSrc());
      return ClientNamenodeProtocolProtos.CheckPermissionResponseProto.newBuilder().setCheckPerm(result).build(); //将结果返回
    } catch (IOException e) {
  ...
  @Override
  public ClientNamenodeProtocolProtos.SayHelloResponseProto sayHello(RpcController controller,
                                                                     ClientNamenodeProtocolProtos.SayHelloRequestProto request) throws ServiceException {
    String result="sayHello"+request.getWord();
    return ClientNamenodeProtocolProtos.SayHelloResponseProto.newBuilder()
            .setReWord(result).build();
  }
